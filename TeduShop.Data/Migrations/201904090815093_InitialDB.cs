    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Procducts", t => t.ProductID, cascadeDelete: true)
                .Index(t => t.OrderID)
                .Index(t => t.ProductID);
                ...
                c => new
                    {
                        ...
                        CreateBy = c.String(),
                        PaymentMethod = c.String(maxLength: 500),
                        PaymentStatus = c.String(nullable: false, maxLength: 500),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Code = c.String(maxLength: 250, unicode: false),
                ...
                c => new
                    {
                        ...
                        IPAddress = c.String(nullable: false, maxLength: 250),
                    })
                .PrimaryKey(t => t.ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductTags", "ProductID", "dbo.Procducts");
            DropForeignKey("dbo.PostTags", "TagID", "dbo.Tags");
            DropForeignKey("dbo.PostTags", "PostID", "dbo.Posts");
            DropForeignKey("dbo.Posts", "CategoryID", "dbo.PostCategories");
            DropForeignKey("dbo.OrderDetails", "ProductID", "dbo.Procducts");
            DropForeignKey("dbo.Procducts", "CategoryID", "dbo.ProductCategories");
            ...
            DropIndex("dbo.Procducts", new[] { "CategoryID" });
